...
ace.define("ace/mode/brainchild", function (require, exports, module) {
  ...
  var BrainChildHighlightRules = require("ace/mode/brainchild_highlight_rules")
    .BrainChildHighlightRules;
...
ace.define("ace/mode/brainchild_highlight_rules", function (
  require,
  exports,
  module
) {
  ...
  var BrainChildHighlightRules = function () {
    var keywords =
      "any|asm|class|else|func|function|if|int|label|metamethod|return|void|while";
